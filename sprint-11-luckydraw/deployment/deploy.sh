#!/usr/bin/env bash
# =============================================================================
# SPRINT 11: AUTOMATED DEPLOYMENT SCRIPT FOR LUCKY DRAW SERVICE
...
SERVICE_NAME="sprint-11-luckydraw-service"
PROJECT_ID="eventhub-saas-platform-2026"
REGION="us-central1"
IMAGE_TAG="gcr.io/${PROJECT_ID}/${SERVICE_NAME}:latest"

echo "======================================================"
echo "🚀 INITIATING SPRINT 11: LUCKY DRAW DEPLOYMENT TO CLOUD RUN"
echo "======================================================"
...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --min-instances=0 \
  --max-instances=5 \
  --set-env-vars="NODE_ENV=production,SERVICE_VERSION=sprint-11-1.0.0"

echo "======================================================"
echo "🎉 DEPLOYMENT SUCCESSFUL!"
echo "Sprint 11 Lucky Draw Service is live on Google Cloud Run."
echo "======================================================"
